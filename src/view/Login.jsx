    ...
    <div className="w-full h-auto min-h-[80vh] flex justify-center items-center">
      <div className="w-auto h-auto py-8 px-12 flex shadow-xl rounded-lg flex-col items-center gap-8">
        ...
        <div className="flex flex-col gap-4">
          <input onKeyPress={login} onChange={n => setUsername(n.target.value)} type="text" className="w-72 px-4 py-3 border border-slate-400
          ...
          <div className="relative block">
            ...
            <input onKeyPress={login} value={password} onChange={pass => setPassword(pass.target.value)}
